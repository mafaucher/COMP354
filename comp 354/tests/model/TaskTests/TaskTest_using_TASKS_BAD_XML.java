...
public class TaskTest_using_TASKS_BAD_XML {
	
	private static StaXParser __StaXParser__;
	
	private static String dataFile = "tests/resources/TASKS_BAD.xml";
	...
	public TaskTest_using_TASKS_BAD_XML (	Task _param1_, 	Boolean _b1_) {				
