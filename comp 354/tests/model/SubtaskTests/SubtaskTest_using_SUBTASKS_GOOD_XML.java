...
public class SubtaskTest_using_SUBTASKS_GOOD_XML {

	private static XMLParser __StaXParser__;
	
	private static String dataFile = "tests/resources/SUBTASKS_GOOD.xml";
	...
	public SubtaskTest_using_SUBTASKS_GOOD_XML (	Subtask _param1_, 	Boolean _b1_) {				
