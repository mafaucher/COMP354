...
public class taskTest__with_staXParser_using_BAD_XML  {
	...
	public taskTest__with_staXParser_using_BAD_XML (	task _param1_, 	Boolean _b1_
    ...
    public static List<Object[]> data() {
    	 ...
    	 List<task> ___task_list_object___=__StaXParser__.readConfig("TASKS_BAD.xml");
